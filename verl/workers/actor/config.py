...
class ActorConfig:
    ...
    loss_agg_mode: str = field(default="token-mean", init=False) # "seq-mean-token-sum-norm" --> turn off seq-dim averaging
    # loss_agg_mode: Literal["token-mean", "seq-mean-token-sum", "seq-mean-token-mean", "seq-mean-token-sum-norm"] = field(default="token-mean", init=False)
