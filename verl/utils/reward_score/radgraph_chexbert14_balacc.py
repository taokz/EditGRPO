...
def radgraph_chexbert14_balacc_compute_score(response_str: str, ground_truth: str, reward_server='http://REWARD_SERVER_HOST:5000/predict', type='cot') -> Dict[str, float]:
    """
    ...
    try:
        ...
        return {
            ...
            "cxb_balanced_accuracy": response["data"]["predictions"]["balanced_accuracy_chexbert"][0],
...
def demo_radgraph_computation():
    ...
    for i, test_case in enumerate(test_cases, 1):
        ...
        score = radgraph_chexbert14_balacc_compute_score(response, reference)
        print(f"Test Case {i}:")
