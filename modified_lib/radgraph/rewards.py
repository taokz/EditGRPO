...
def compute_reward(
    ...
    # Compute precision, recall, and F1 for all reward levels
    simple_precision, simple_recall, simple_f1 = exact_entity_token_match_reward(hypothesis_annotation_list, reference_annotation_list)
    partial_precision, partial_recall, partial_f1 = exact_entity_token_if_rel_exists_reward(hypothesis_annotation_list, reference_annotation_list)
    complete_precision, complete_recall, complete_f1 = exact_entity_token_if_all_match_reward(hypothesis_annotation_list, reference_annotation_list)
    
    # Return based on reward_level
    if reward_level == "simple":
        return simple_f1  # Backward compatibility
    elif reward_level == "partial":
        return partial_f1  # Backward compatibility
    elif reward_level == "complete":
        return complete_f1  # Backward compatibility
    elif reward_level == "all":
        return (
            (simple_precision, simple_recall, simple_f1),
